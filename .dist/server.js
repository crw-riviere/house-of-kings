...
/******/ 	var hotCurrentHash = "688f8786116fc55fce3a"; // eslint-disable-line no-unused-vars
...
var _deck = __webpack_require__("./src/models/deck.js");
...
var _game = __webpack_require__("./src/models/game.js");
...
var _server = __webpack_require__("./src/server/server.js");
...
var _gameList = __webpack_require__("./src/models/gameList.js");

var _gameList2 = _interopRequireDefault(_gameList);

var _rules = __webpack_require__("./src/models/rules.js");
...
var io = __webpack_require__("socket.io")(httpServer);
...
if (true) {
  module.hot.accept("./src/server/server.js", function () {
...
var server = express();
var http = __webpack_require__("http").Server(server);

var PublicPath = '.dist';

var io = __webpack_require__("socket.io")(http, {
  origins: ['*']
});
