...
var _gameList = __webpack_require__(8);
...
var io = __webpack_require__(1)(httpServer);
...
io.on('connection', function (socket) {
  ...
  socket.on('pickCard', function () {
    ...
    var pickedCard = game.userPickCard(socket.username);
    if (pickedCard) {
      ...
      var rule = _rules2.default.get(pickedCard.number);
...
var server = express();
var http = __webpack_require__(0).Server(server);

var PublicPath = '.dist';

var io = __webpack_require__(1)(http, {
  origins: ['*']
});
...
exports.default = new Map([['A', {
  ...
  title: 'Straight',
  description: 'Whoever is opposite you must drink'
}], ['9', {
  title: 'Rhyme',
